...
class _$DrugCopyWithImpl<$Res, $Val extends Drug>
  ...
  $Res call({
    ...
    Object? type = freezed,
    Object? activeIngredient = freezed,
...
class _$DrugImpl implements _Drug {
  ...
  @override
  String toString() {
    return 'Drug(id: $id, name: $name, category: $category, type: $type, activeIngredient: $activeIngredient, manufacturer: $manufacturer, uses: $uses, dosage: $dosage, contraindications: $contraindications, sideEffects: $sideEffects)';
  }
